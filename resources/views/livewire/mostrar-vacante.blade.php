<div class="p-10">
    <div class="mb-5 ">
        ...
        <div class=" md:grid md:grid-cols-2 bg-gray-50 p-4 my-10">
            ...
            <p class="font-bold text-sm uppercase text-gray-800 my-3">
                Ultimo día para postularse:<span
    ...
    <div class="mt-5 bg-gray-50 border border-dashed text-center">
        <p>
            ¿Deseas aplicar a una vacante?<a class="font-bold text-indigo-600" href="{{route('register')}}">Obten una
                cuenta
                y aplica a esta y otras vacantes</a>
        </p>
    </div>
    @endguest
